...
public class AddTaskUI implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == button3) {
            ...
            for (int i = 0; i < deadlines.size(); i++) {
                ...
                Date deadline = null;
                try {
                    deadline = df.parse(deadlines.get(i).getText());
                } catch (ParseException ex) {
                    Logger.getLogger(AddTaskUI.class.getName()).log(Level.SEVERE, null, ex);
                }
                int weight = Integer.parseInt((String)weights.get(i).getSelectedItem());
